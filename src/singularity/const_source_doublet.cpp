...
// }
//
void SourceDoubletP::calcInfluenceImpl(Eigen::Ref<Eigen::ArrayXf> sourceMat,
  ...
  sourceMat *= -1 / (4 * std::numbers::pi_v<float>);
  doubletMat *= -1 / (4 * std::numbers::pi_v<float>);
}
...
//   return infMat;
// }
float SourceDoubletP::calcSelfInfluenceImpl() { return 0.5; }
